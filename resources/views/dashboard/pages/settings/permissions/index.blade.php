                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-permission-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            ...
                            <i class="ki-outline ki-plus fs-3"></i>Tambah Permission</button>
                        <!--end::Button-->
                    </div>
                    <!--end::Toolbar-->
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none"
                        ...
                        <div class="fw-bold me-5">
                            <span class="me-2" data-kt-permission-table-select="selected_count"></span>Selected
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-icon btn-sm btn-active-icon-primary" id="kt_modal_add_permission_close">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_add_permission_form" class="form" action="#">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Masukkan nama permission"
                                    name="name" required />
                                <!--end::Input-->
                                <!--begin::Error message-->
                            ...
                            <div class="text-center pt-15">
                                <button type="reset" class="btn btn-light me-3"
                                    id="kt_modal_add_permission_cancel">Batal</button>
                                <button type="submit" class="btn btn-primary" id="kt_modal_add_permission_submit">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-icon btn-sm btn-active-icon-primary" id="kt_modal_update_permission_close">
                            <i class="ki-outline ki-cross fs-1"></i>
                        </div>
                        <!--end::Close-->
                    </div>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_update_permission_form" class="form" action="#">
                            ...
                            <div class="text-center pt-15">
                                <button type="reset" class="btn btn-light me-3"
                                    id="kt_modal_update_permission_cancel">Batal</button>
                                <button type="submit" class="btn btn-primary" id="kt_modal_update_permission_submit">
...
@push('custom-script')
    <script src="{{ asset('template/assets/js/custom/apps/user-management/permissions/list-updated.js') }}"></script>
@endpush
